...
<div class="senar-form">
	...
	<?php 
        //$content = file_get_contents($merek);
        $json = Json::decode($merek);		
        $instArray = ArrayHelper::map($json,'merek','merek');
		
        echo $form->field($model, 'STRING_BRAND')->dropDownList($instArray);		
	?>
